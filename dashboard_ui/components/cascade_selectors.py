...
def render_cascade_selectors(
    ...
    show_sistema: bool = True
) -> Tuple[Optional[int], Optional[int], Optional[int]]:
    """
    Renderiza selectboxes encadeados (Fábrica -> Linha -> Sistema).
    Retorna a tupla (fabrica_id, linha_id, sistema_id).
    Se show_sistema=False, renderiza apenas Fábrica e Linha.
    """
    if show_sistema:
